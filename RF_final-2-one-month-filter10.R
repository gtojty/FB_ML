...
#0.2517533
# one month data, 0.193 p=0.0006
rmse(testset1$mean.swl,pred2[,2])
#one month data - 1.38 (range for SWL in full one month dataset is 1.2 to 6.8, arguably an error of 1.4 would still be useful for aiding diagnosis)
...
#0.3622124
#0.3562766
# one month data, cor = 0.17, p=0.0014, RMSE = 1.35
...
#0.25
#one month data, cor = 0.24, p=1.39e-05, RMSE = 1.33
...
rmse(testset1$mean.swl,testset1$Prediction1)
#0.3405363
#one month dataset, cor=0.14, p=0.01, RMSE=1.36
